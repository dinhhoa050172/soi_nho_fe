"use client"
import { Box, HandCoins, Layers, LayoutDashboard, ListCheck, Package, User } from "lucide-react"
import {
    Sidebar,
    SidebarContent,
    SidebarGroup,
...
const items = [
    ...
    {
        title: "Chất liệu",
        url: "/dashboard/manage-materials",
        icon: Box,
    },
    {
        title: "Danh mục",
    ...
    {
        title: "Giao dịch",
        url: "/dashboard/manage-transaction",
        icon: HandCoins,
    },
]
    ...
    return (
        <Sidebar collapsible="icon">
            <SidebarContent>
                ...
                <div className={isCollapsed ? "mt-auto pb-4 flex justify-center" : "mt-auto pb-4"}>
                    <Button
